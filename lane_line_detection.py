# -*- coding: utf-8 -*-
"""lane-line-detection.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZHE1WAEOQChv1IT9Iy4ZxYXrVYWSu13L
...
"""## Test on kerala roads

"""

fig = plt.figure(figsize=(20, 10))
image = mpimg.imread('../content/kerala-road-31.07.2019280072_1564542524 (1).jpg')
image = cv2.cvtColor(image, cv2.COLOR_BGRA2RGB)
# Convert image to float64 before scaling
...
# Commented out IPython magic to ensure Python compatibility.
white_output = '/content/solidWhiteRight.mp4'
...
clip1 = VideoFileClip("/content/solidYellowLeft.mp4")
...
# ... (Your existing functions: grayscale, canny, gaussian_blur, region_of_interest, draw_lines, slope_lines, hough_lines, weighted_img, get_vertices, lane_finding_pipeline) ...

yellow_output = './solidYellowLeft_output.mp4' # Changed output file name to avoid overwriting
clip2 = VideoFileClip('/content/solidYellowLeft.mp4')
yellow_clip = clip2.fl_image(lane_finding_pipeline) # Apply lane detection pipeline to each frame
# %time yellow_clip.write_videofile(yellow_output, audio=False) # Write output video file
...
### **Author: [Manikandan M](https://www.linkedin.com/in/mmanikandan281/)**  
[Let's Connect](https://www.linkedin.com/in/mmanikandan281/
)
"""